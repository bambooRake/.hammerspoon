...
qDown = 0
qUp = 0
-- function dragMouse(lp)
--     local lpos = hs.mouse.getAbsolutePosition()
--     if pressLeft then
--         if lp["x"]~=lpos["x"] or lp["y"]~=lpos["y"] then
--             if not dragStart then
--                 dragStart = true
--                 print("dragStart")
--                 local llpos = { x = lpos["x"]-5, y = lpos["y"]-5}
--                 hs.eventtap.event.newMouseEvent(hs.eventtap.event.types["leftMouseUp"], lp):setProperty(hs.eventtap.event.properties.mouseEventClickState, pClickCount):post()
--                 hs.eventtap.event.newMouseEvent(hs.eventtap.event.types["leftMouseDown"], lp):setProperty(hs.eventtap.event.properties.mouseEventClickState, pClickCount):post()
--                 hs.eventtap.event.newMouseEvent(hs.eventtap.event.types["leftMouseDragged"], llpos):setProperty(hs.eventtap.event.properties.mouseEventClickState, pClickCount):post()
--             else 
--                 hs.eventtap.event.newMouseEvent(hs.eventtap.event.types["leftMouseDragged"], lpos):setProperty(hs.eventtap.event.properties.mouseEventClickState, 1):post()
--             end
--         end
--         hs.timer.doAfter(0.02, function() dragMouse(lpos) end)
--     end
-- end
